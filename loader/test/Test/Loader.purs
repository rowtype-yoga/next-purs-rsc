...
testGenerateTsx = do
  clientTsx `shouldContain` "\"use client\";"
  ...
  serverPageTsx `shouldNotContain` "\"use client\""

  layoutTsx `shouldContain` "render(props)"
  layoutTsx `shouldNotContain` "params"

  errorTsx `shouldContain` "\"use client\";"
  ...
  fooTsx `shouldContain` "\"../output/Page.Foo/index.js\""
  where
